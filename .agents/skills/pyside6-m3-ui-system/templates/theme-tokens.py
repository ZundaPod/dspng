...
Copy this file into your project and import tokens via the TokenRegistry.
Never hardcode these values in widget code; always reference tokens by name.
"""
...
# Typography Tokens
# ==============================================================================
FONT_FAMILY = "Segoe UI" if sys.platform == "win32" else "SF Pro Display" if sys.platform == "darwin" else "Noto Sans"
